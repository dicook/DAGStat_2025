---
title: "Visually exploring high-dimensional market segmentation data"
...
code-fold: true
footer: "DAGStat 2025 - https://dicook.github.io/DAGStat_2025/"
---
...
::: {.fragment}
<br><br> <span style="color:#EC5C00"> Stay tuned for new work to appear later this year </span>
:::
...
Result of $k$-means with Euclidean distance into 6 clusters
...
::: {.fragment}
*We wouldn't cluster the data this way, but the clustering algorithms don't see gaps like we do.* See also [flexclust](https://cran.r-project.org/web/packages/flexclust/index.html) for alternative clustering approaches.
:::
...
::: {.fragment}
27 variables contributing to projection 
:::
...
::: {.fragment}
Cluster 6 consists of tourists who like going to health facilities and drinking wine. 
...
::: {.fragment}
Cluster 3 consists of tourists who very much like going to a disco or bar.
...
With market segmentation, it is used to examine where the partitions are made, to address questions like: 

- Are the partitions sensible? 
- Would some adjustment produce a more useful partition? 
- Can the solution be simplified, and be equally effective?
:::

All of these are easier with *direct manipulation interactive graphics* tools: stay tuned for **Dr Laa's presentation next**!
...
Somewhere in Berlin there is now a little *R sticker graffiti*!

:::: {.columns}
::: {.column}
<center>
![](images/R-sticker-graffiti1.jpg){width=60%}
</center>
:::
::: {.column}
<center>
![](images/R-sticker-graffiti2.jpg){width=60%}
</center>
:::
::::
...
## Extra slides {.transition-slide visibility="uncounted"}

## Slice {visibility="uncounted"}
...
## Sage transformation [(1/2)]{.f50 visibility="uncounted"}
...
## Sage transformation [(2/2)]{.f50 visibility="uncounted"}
...
## Givens [(1/2)]{.f50 visibility="uncounted"}
...
## Givens [(2/2)]{.f50 visibility="uncounted"}
...
## Interactivity: exploration {visibility="uncounted"}
...
## Interactivity: Compare cluster models {visibility="uncounted"}
